...
export class CreatePlatformVoucherDto {
  ...
  @IsNumber() @Min(1) thresholdPoints!: number;
...
export class UpdatePlatformVoucherDto {
  @IsOptional() @IsString() title?: string;
  @IsOptional() @IsString() description?: string;
  @IsOptional() @IsNumber() @Min(1) thresholdPoints?: number;
  @IsOptional() @IsIn(REWARD_TYPES) rewardType?: string;
  @IsOptional() @IsNumber() rewardValue?: number;
  @IsOptional() @IsString() rewardLabel?: string;
  @IsOptional() @IsIn(STATUSES) status?: string;
...
export class RedeemPlatformVoucherDto {
