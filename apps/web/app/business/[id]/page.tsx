          ...
          <div className="md:col-span-2">
            ...
            <Card className="p-6 rounded-2xl mb-8">
              ...
              <p className="text-muted-foreground mb-4">
                This is a detailed description of the business and its services. Lorem ipsum dolor
                ...
                {[1, 2, 3].map((i) => (
                  <div key={i} className="pb-4 border-b border-border last:border-0">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex gap-1">
                            {[...Array(5)].map((_, j) => (
                              <Star
                                key={j}
                                className={`h-4 w-4 ${j < 5 ? 'fill-yellow-400 text-yellow-400' : 'text-muted-foreground'}`}
                              />
                            ))}
                          </div>
                    ...
                    <p className="text-muted-foreground">
                      Great place! Would definitely recommend to friends and family.
                    </p>
                  </div>
                ))}
              </div>
