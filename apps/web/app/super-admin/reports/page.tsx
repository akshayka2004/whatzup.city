                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">
                        Reported Target: <span className="text-foreground font-semibold">{report.reported}</span> • Received {report.date}
                      </p>
                    </div>
            ...
            <Card className="w-full max-w-md p-6 rounded-2xl border-border bg-card shadow-2xl relative">
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-secondary p-4 rounded-xl border border-border">
                  <p className="text-xs text-muted-foreground font-semibold mb-1">Target Entity Under Report</p>
                  <p className="text-sm font-bold text-foreground">{viewingReport.reported}</p>
                </div>
                <div className="bg-secondary p-4 rounded-xl border border-border">
                  <p className="text-xs text-muted-foreground font-semibold mb-1">Report Description & Evidence</p>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <Card className="w-full max-w-sm p-6 rounded-2xl border-border bg-card shadow-2xl relative text-center">
              ...
              <div className="flex justify-center gap-3">
                <Button onClick={() => setDeletingReport(null)} variant="outline" className="rounded-xl border-border hover:bg-secondary text-foreground px-4">
                  Cancel
                </Button>
                <Button onClick={handleDeleteReport} className="rounded-xl bg-destructive hover:bg-destructive text-white px-4">
                  Delete Report
                </Button>
              </div>
            </Card>
