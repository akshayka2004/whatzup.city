...
// Shared by /admin/notices and /staff/announcements — same CRUD, different Layout wrapper.
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Broadcast official notices, government safety alerts, and system bulletin news
          </p>
        </div>
        <Button
          onClick={openCreate}
              ...
              <div className="flex items-start gap-4 flex-1 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    Sender: {note.sender} • Date: {note.date}
                  </p>
                  {/* Tags */}
                  {note.tags.length > 0 && (
          ...
          <Card className="w-full max-w-md p-6 rounded-2xl border-border bg-card shadow-2xl relative">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  {viewingNotice.sender} • {viewingNotice.date}
                </p>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <Card className="w-full max-w-sm p-6 rounded-2xl border-border bg-card shadow-2xl relative text-center">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Delete{' '}
              <span className="font-semibold text-foreground">"{deletingNotice.title}"</span>?
            </p>
