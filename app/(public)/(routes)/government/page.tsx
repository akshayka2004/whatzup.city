  ...
  return (
    <PublicLayout>
      <div>
        ...
        <p className="text-muted-foreground mb-8">Stay informed with official notices and announcements</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap ${typeColors[notice.type] || typeColors.Announcement}`}>
                      {notice.type}
                    </span>
                  </div>
