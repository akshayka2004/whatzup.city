...
const reports = [
  { id: 1, type: 'Inappropriate Content', reported: 'Business A', date: '2024-05-16', status: 'Pending' },
  { id: 2, type: 'Fraudulent Activity', reported: 'User B', date: '2024-05-15', status: 'Under Review' },
  { id: 3, type: 'Policy Violation', reported: 'Business C', date: '2024-05-14', status: 'Resolved' },
            ...
            <Card key={report.id} className="p-6 rounded-2xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-medium ml-auto ${statusColors[report.status]}`}>
                    {report.status}
                  </span>
                </div>
