...
Write-Host "🚀 SaaS Monorepo: Building & Pushing Production Images to Docker Hub" -ForegroundColor Cyan
...
Write-Host "🛠️  Building production-grade images using Docker Compose..." -ForegroundColor Yellow
